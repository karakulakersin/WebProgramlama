...
namespace BlogSosyalMedya.Controllers
{
    public class UlkeController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,UlkeAd,BulunduguKita")] Ulke ulke)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,UlkeAd,BulunduguKita")] Ulke ulke)
        {
            if (id != ulke.Id)
            {
                return NotFound();
