...
namespace BlogSosyalMedya.Controllers
{
    public class KategoriController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,KategoriAdı")] Kategori kategori)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,KategoriAdı")] Kategori kategori)
        {
            if (id != kategori.Id)
            {
                return NotFound();
